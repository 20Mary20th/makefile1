...
; Note the Drupal core project first before proceeding to note the modules you want to install beforehand (projects[] = drupal)
...
; Contrib Modules
; From these, you can add additional contrib modules you wanted to your Drupal directory of your contrib modules along with its version
...
projects[token][subdir] = "token"
projects[webform][subdir] = "contrib"
projects[wysiwyg][subdir] = "contrib"

; Some modules like third party software, tools and libraries can also be included in Drush Make File
